...
export function MemoryStoryTimelineDetailSection({
  ...
  return (
    <div className={`mx-4 mt-4 ${MEMORY_ARCHIVE_SERIF_CLASS}`} style={archiveSerifTextStyle}>
      {showSectionHeading ? (
      ...
      <section className={ARCHIVE_SOFT_SECTION}>
        ...
        <p className="mb-3 text-[12px] leading-relaxed text-gray-500">
          每轮自动写入失败时，可粘贴本轮剧情 / 私聊正文后在此单独请求摘要并落库。
        </p>
        <textarea
          value={alignDraft}
