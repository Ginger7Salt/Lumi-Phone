...
import { ListenProfileShareCard } from './ListenProfileShareCard'
...
/** 听一听主页分享聊天气泡行 */
export function ListenProfileShareChatRow({
  id,
  isSelf,
  data,
  bubble,
  ...
  const avatarPx = 40
  const card = <ListenProfileShareCard data={data} onOpen={onOpen} />
